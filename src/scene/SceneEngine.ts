...
function renderAuxiliaryArrays(scene: SceneState, teachingState: TeachingState | undefined): SceneState {
  ...
  // 主数组(arr_*)的左边缘:辅助数组(计数/输出等)左对齐到它,使输入/计数/输出
  // 各行共享同一左边缘;主数组本身保持原位,不影响其它算法。
