...
import { resolveAnchor } from './EdgeRenderer'
  ...
  return (
    <g>
      ...
      <rect x={x - 24} y={y - 14} width={48} height={22} rx={6}
        fill={SEMANTIC_COLORS.primary.fill} stroke={SEMANTIC_COLORS.primary.stroke} strokeWidth={1} />
      ...
      {target ? (
        <line x1={x} y1={y + 8} x2={target.x} y2={target.y - 24}
          stroke={SEMANTIC_COLORS.primary.stroke} strokeWidth={1.5} markerEnd="url(#scenePointerArrow)" />
      ) : (
