...
export function generateLeetCode(): AnimationScript {
  ...
  return { algorithm: 'leetcode_hot100', complexity: { time: { best: 'O(n)', average: 'O(n)', worst: 'O(n)' }, space: 'O(n)' }, initialState: { type: 'array', data: arr }, steps: steps as AnimationScript['steps'] }
}
